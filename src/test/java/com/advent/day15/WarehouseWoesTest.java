...
public class WarehouseWoesTest extends BasePuzzleTest<WarehouseWoes> {
    ...
    @Override
    public WarehouseWoes getPuzzle() {
        return new WarehouseWoes();
    }

    @Override
    public Stream<Arguments> part1Samples() {
        return Stream.of(Arguments.of(EXAMPLE_1, 10092), Arguments.of(EXAMPLE_2, 2028));
    }
